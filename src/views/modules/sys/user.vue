  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http.getAdminList(this.pageSize, this.pageIndex).then(res => {
          if (res && res.code === 200) {
            this.dataList = res.page.data.data
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${userIds.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http.deleteUser(userIds).then(res => {
            if (res.code === 200) {
              this.$message({
                message: '操作成功',
                type: 'success',
              ...
              this.$http.setLog(`删除了id=${id}的管理员`, 'admin/System/deleteUser')
            } else {
