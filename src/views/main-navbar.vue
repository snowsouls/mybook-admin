  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">mybook我的书屋</a>
        <a class="site-navbar__brand-mini" href="javascript:;">mybook</a>
      </h1>
    </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      userName: {
        get () { return this.$store.state.user.user.name }
      }
    },
    methods: {
      // 修改密码
      ...
      logoutHandle () {
        ...
        this.$confirm(`确定进行[退出]操作?`, '提示', {
          ...
          _this.$http.setLog('退出了系统', 'admin/index/setLog').then(res => {
            if (res && res.code === 200) {
              clearLoginInfo()
